    ...
    <div className="md:sticky top-12 flex flex-row-reverse md:flex-col gap-4 md:space-y-8">
      {aboutMe.imageUrl && (
        <div className="w-1/3 md:w-full flex-shrink-0">
          <div className="relative max-h-[45vh] md:w-[65%] aspect-[3/4] mx-auto">
            <Image
          ...
          {aboutMe.funDescription && (
            <div className="w-full mt-4 flex justify-center">
              <div className="relative inline-block">
                <p className="font-serif text-sm text-zinc-600 tracking-wide px-6 py-2.5 bg-gradient-to-r from-zinc-50 via-white to-zinc-50 rounded-lg hover:from-white hover:to-white transition-all duration-500">
                  {aboutMe.funDescription}
                </p>
                <div className="absolute inset-0 rounded-lg border-b border-zinc-200/80"></div>
              </div>
            </div>
          )}
        </div>
